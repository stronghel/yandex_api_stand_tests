...
def get_user_body(first_name):
    # копирование словаря с телом запроса из файла data,copy() - чтобы не потерять данные в исходном словаре
...
def negative_assert_symbol(first_name):
    ...
    # Проверяется, что в теле ответа атрибут message такой:
    # "Имя пользователя введено некорректно. Имя может содержать только русские или латинские буквы,
...
def test_create_user_16_letter_in_first_name_get_error_response():
        ...
        # Параметр fisrtName QWErty
def test_create_user_english_letter_in_first_name_get_success_response():
                positive_assert("QWErty")

        # Тест 6. Разрешены русские символы
        # Параметр fisrtName Мария
def test_create_user_russian_letter_in_first_name_get_success_response():
                positive_assert("Мария")

        # Тест 7. ошибка
        # Запрещены пробелы
        # Параметр fisrtName Человек и Ко
